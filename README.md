...
- **Mean-Square Size**: Defined as  $\Delta \equiv$ $`\Delta \equiv \langle \left| \vec{r}_i - \vec{r}_{\text{cm}} \right|^2 \rangle`$, where $\vec{r}_i$ is the position of the $\i-th$ amino acid and $\vec{r}_{\text{cm}}$ is the center of mass.
